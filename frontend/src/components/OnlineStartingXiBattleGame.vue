    ...
    <template v-if="state && !state.finished">
      ...
      <div class="mp-player-row">
        <div
          ...
          :class="{ 'active-turn': p.participantId === state.currentTurnParticipantId && !state.lineupComplete, eliminated: p.eliminatedThisLineup, disconnected: p.connected === false && p.participantId !== props.yourParticipantId }"
      ...
      <div v-if="!state.lineupComplete && isYourTurn" class="guess-box-wrap no-print">
        <p class="guess-box-turn-label">Your turn</p>
