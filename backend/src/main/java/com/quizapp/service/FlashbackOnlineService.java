...
public class FlashbackOnlineService {
    ...
    public void restartForReplay(GameRoom room) {
        ...
        initializeYearSequence(room, previousCount);
    }
    ...
    public void kick(GameRoom room, Long participantId) {
        roundGuessRepository.deleteByParticipant_Id(participantId);
